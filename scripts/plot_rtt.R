...
rooted_trees <- readRDS("data/global_ST2_tree/rooted_trees.rds")
...
ggsave(filename = "results_manual/root_to_tip/FigS4A_root_to_tip.pdf")
ggsave(filename = "results_manual/root_to_tip/FigS4A_root_to_tip.png")
